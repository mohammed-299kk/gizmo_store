...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void _initializeControllers() {
    ...
    _priceController = TextEditingController(text: (data['price'] ?? 0).toString());
    ...
    _stockController = TextEditingController(text: (data['stock'] ?? 0).toString());
    _specificationsController = TextEditingController();
    
    _selectedCategory = data['category'] ?? '';
    _selectedCurrency = data['currency'] ?? 'SAR'; // Default to SAR instead of hardcoded Arabic
  ...
  Future<void> _updateProduct() async {
    ...
    try {
      ...
      await ProductService.updateProduct(widget.productId, product, context);
                ...
                children: [
                  ...
                  Expanded(
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: (value) {
                         setState(() {
                           _selectedCurrency = value ?? AppLocalizations.of(context)!.sudanesePound;
                         });
                       },
                    ),
                  ),
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          Expanded(
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText: AppLocalizations.of(context)!.addSpecification,
                                border: const OutlineInputBorder(),
                              ),
                            ),
                          ),
                      ...
                      if (_specifications.isNotEmpty) ...{
                        const SizedBox(height: 16),
                        Text('${AppLocalizations.of(context)!.currentSpecifications}:'),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      SwitchListTile(
                        title: Text(AppLocalizations.of(context)!.availableForSale),
                        value: _isAvailable,
                        onChanged: (value) {
                          setState(() {
                            _isAvailable = value;
