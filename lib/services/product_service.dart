...
class ProductService {
  ...
  static Future<String> uploadProductImage(
    ...
    try {
      ...
      if (urls.isEmpty) {
        ...
        throw Exception(
            'فشل في رفع الصورة إلى Cloudinary - لم يتم إرجاع أي URLs');
      }
  ...
  static Future<void> toggleProductAvailability(
      String id, bool isAvailable, BuildContext context) async {
    try {
  ...
  static Future<void> updateProduct(Product product) async {
    ...
    try {
      ...
      Map<String, dynamic> productData = {
        ...
        'imageUrl': images.isNotEmpty ? images.first : product.image,
      ...
      if (e.toString().contains('permission-denied')) {
        ...
        throw Exception(
            'ليس لديك صلاحية لتحديث المنتجات. تأكد من تسجيل الدخول كمدير.');
