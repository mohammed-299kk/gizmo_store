      ...
      body: ListView(
        ...
        children: [
          ...
          Consumer<LanguageProvider>(
            builder: (context, languageProvider, child) {
              return _buildDropdownTile(
                ...
                onChanged: (value) {
                  String languageCode = value == AppLocalizations.of(context)!.languageArabic ? 'ar' : 'en';
          ...
          _buildSettingTile(
            ...
            onTap: () => _showComingSoon(AppLocalizations.of(context)!.privacyPolicy),
          ),
          ...
          _buildSettingTile(
            ...
            onTap: () => _showComingSoon(AppLocalizations.of(context)!.termsOfService),
          ),
